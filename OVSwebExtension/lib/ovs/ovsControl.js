...
// Startup Code //
    ...
    if (loadingDiv === null) {
        loadingDiv ='<div id=Loading class=loading> <span class="fa fa-circle-o-notch fa-spin"></span></div>';
        eBody.innerHTML += loadingDiv;
        console.log("loadingDiv Added");  
    }
    let phoneDiv = document.getElementById('Phone');
    if (phoneDiv === null) {
        phoneDiv = '<div id="Phone"></div>';
        eBody.innerHTML += phoneDiv;
    ...
    link.rel = "stylesheet";
    link.type = "text/css";
    link.href = hostingPrefex + "lib/fonts/font_awesome/css/font-awesome.min.css";
    link.addEventListener('load', (event) => {console.log(link.href   + ' file has been loaded');});
    head.appendChild(link);
    console.log(link.href + " done");

    link = document.createElement("link");
    link.rel = "stylesheet";
    link.type = "text/css";
    link.href = hostingPrefex + "lib/jquery/jquery-ui.min.css";
    head.appendChild(link);
    console.log(link.href + " done");
    ...
    link.rel = "stylesheet";
    link.type = "text/css";
    link.href = hostingPrefex + "lib/Normalize/normalize-v8.0.1.css";
    head.appendChild(link);
    console.log(link.href + " done");
    ...
    link.rel = "stylesheet";
    link.type = "text/css";
    link.href = hostingPrefex + "lib/fonts/font_roboto/roboto.css";
    head.appendChild(link);
    console.log(link.href + " done");
    ...
    link.rel = "stylesheet";
    link.type = "text/css";
    link.href = hostingPrefex + "lib/Croppie/croppie.css";
    head.appendChild(link);
    console.log(link.href + " done");
    ...
    link.rel = "stylesheet";
    link.type = "text/css";
    link.href = hostingPrefex + "css/phone.css";
    head.appendChild(link);
    console.log(link.href + " done");
    ...
    s0.src = hostingPrefex + "lib/ovs/sip-0.20.0.min.js";
    s0.addEventListener('load', (event) => {console.log(s0.src   + ' file has been loaded');});
    head.appendChild(s0);
    console.log(s0.src + " done");


    s0 = document.createElement("script");
    s0.type = "text/javascript";
    s0.src = hostingPrefex + "lib/Chart/Chart.bundle-2.7.2.js";
    s0.addEventListener('load', (event) => {console.log(s0.src   + ' file has been loaded');});
    head.appendChild(s0);
    console.log(s0.src + " done");
    ...
    s0 = document.createElement("script");
    s0.type = "text/javascript";
    s0.src = hostingPrefex + "lib/FabricJS/fabric-2.4.6.min.js";
    s0.addEventListener('load', (event) => {console.log(s0.src   + ' file has been loaded');});
    head.appendChild(s0);
    console.log(s0.src + " done");
    ...
    s0 = document.createElement("script");
    s0.type = "text/javascript";
    s0.src = hostingPrefex + "lib/Moment/moment-with-locales-2.24.0.min.js";
    s0.addEventListener('load', (event) => {console.log(s0.src   + ' file has been loaded');});
    head.appendChild(s0);
    console.log(s0.src + " done");
    ...
    s0 = document.createElement("script");
    s0.type = "text/javascript";
    s0.src = hostingPrefex + "lib/Croppie/croppie-2.6.4.min.js";
    s0.addEventListener('load', (event) => {console.log(s0.src   + ' file has been loaded');});
    head.appendChild(s0);
    console.log(s0.src + " done");
    ...
    s0 = document.createElement("script");
    s0.type = "text/javascript";
    s0.src = hostingPrefex + "lib/XMPP/strophe-1.4.1.umd.min.js";
    s0.addEventListener('load', (event) => {console.log(s0.src   + ' file has been loaded');});
    head.appendChild(s0);
    console.log(s0.src + " done");
    ...
    s1.src = hostingPrefex + "lib/jquery/jquery-3.3.1.min.js";
    s1.addEventListener('load', (event) => {
        console.log(s1.src   + ' file has been loaded');
        // wait for jqury to be loaded, before addting its events
        let s4 = document.createElement("script");
        s4 = document.createElement("script");
        s4.type = "text/javascript";
        s4.src = hostingPrefex + "lib/ovs/jQueryLoader.js";
        s4.addEventListener('load', (event) => {console.log(s4.src   + ' file has been loaded');});
        head.appendChild(s4);
        console.log(s4.src + " done");        
    });
    head.appendChild(s1);
    ...
    s2.src = hostingPrefex + "lib/jquery/jquery.md5-min.js";
    ...
    s3.src = hostingPrefex + "lib/jquery/jquery-ui.min.js";
    ...
    setDbItem("VideoHeight", "240");
    setDbItem("FrameRate", "15");
    setDbItem("AspectRatio", "rotateY(180deg)");
    setDbItem("VideoOrientation", "1.33");
...
function setDbItem(itemIndex, value) {
    try {
      window.localStorage.setItem(itemIndex, value);
    } catch (error) {
      console.error(error);
    }
    return value;
...
function AddSomeoneWindow(numberStr){
    ...
    buttons.push({
        ...
        action: function(){
            ...
            setDbItem(profileUserID + "-Buddies", JSON.stringify(json));
    ...
    OpenWindow(html, lang.edit, 480, 640, false, true, lang.save, function(){
        ...
        $("#ImageCanvas").croppie('result', constraints).then(function(base64) {
            if(buddyJson.Type == "extension"){
                setDbItem("img-"+ buddyJson.uID +"-extension", base64);
...
function SetStatusWindow(){
    ...
    OpenWindow(windowHtml, lang.set_status, 180, 350, false, false, "OK", function(){
        ...
        setDbItem("XmppLastPresence", presenceStr);
        setDbItem("XmppLastStatus", statusStr);
    ...
    if(welcomeScreen){
        if(localDB.getItem("WelcomeScreenAccept") != "yes"){
            OpenWindow(welcomeScreen, lang.welcome, 480, 600, true, false, lang.accept, function(){
                setDbItem("WelcomeScreenAccept", "yes");
                CloseWindow();
                ShowMyProfile();
            }, null, null, null, null);
...
function ApplyThemeColor(){
    ...
    var cssUrl = hostingPrefex +"css/phone.light.css";
...
function AnswerVideoCall(lineNumber) {
    ...
    if(currentVideoDevice != "default"){
        ...
        if(confirmedVideoDevice){
            ...
            setDbItem("VideoSrcId", "default"); // resets for later and subsequent calls
        }
    }
    // Add additional Constraints
...
function InitinaliseStream(buddy){
    ...
    setDbItem(buddy + "-stream", JSON.stringify(template));
...
function SendChatMessage(buddy) {
    ...
    setDbItem(buddy + "-stream", JSON.stringify(currentStream));
...
function MarkMessageSent(buddyObj, messageId, refresh){
    ...
    if(currentStream != null || currentStream.DataCollection != null){
        ...
        setDbItem(buddyObj.identity + "-stream", JSON.stringify(currentStream));
...
function InitUserBuddies(){
    var template = { TotalRows:0, DataCollection:[] }
    setDbItem(profileUserID + "-Buddies", JSON.stringify(template));
...
function RemoveBuddyMessageStream(buddyObj, days){
    ...
    if(days && days > 0){
        if(stream && stream.DataCollection && stream.DataCollection.length >= 1){
            ...
            setDbItem(buddyObj.identity + "-stream", JSON.stringify(trimmedStream));
...
function ShowMyProfile(){
    ...
    buttons.push({
        ...
        action: function(){
            ...
            if(localDB.getItem("profileUserID") == null) setDbItem("profileUserID", uID()); // For first time only
    
            // 1 Account
            if(EnableAccountSettings){
                setDbItem("wssServer", $("#Configure_Account_wssServer").val());
                setDbItem("WebSocketPort", $("#Configure_Account_WebSocketPort").val());
                setDbItem("ServerPath", $("#Configure_Account_ServerPath").val());
                setDbItem("profileUser", $("#Configure_Account_profileUser").val());
                setDbItem("profileName", $("#Configure_Account_profileName").val());
                setDbItem("SipUsername", $("#Configure_Account_SipUsername").val());
                setDbItem("SipPassword", $("#Configure_Account_SipPassword").val());
        
                setDbItem("ChatEngine", chatEng);
        
                setDbItem("XmppDomain", $("#Configure_Account_xmpp_domain").val());
                setDbItem("XmppServer", $("#Configure_Account_xmpp_address").val());
                setDbItem("XmppWebsocketPort", $("#Configure_Account_xmpp_port").val());
                setDbItem("XmppWebsocketPath", $("#Configure_Account_xmpp_path").val());
            }
    
            // 2 Audio & Video
            setDbItem("AudioOutputId", $("#playbackSrc").val());
            setDbItem("VideoSrcId", $("#previewVideoSrc").val());
            setDbItem("VideoHeight", $("input[name=Settings_Quality]:checked").val());
            setDbItem("FrameRate", $("input[name=Settings_FrameRate]:checked").val());
            setDbItem("AspectRatio", $("input[name=Settings_AspectRatio]:checked").val());
            setDbItem("VideoOrientation", $("input[name=Settings_Oriteation]:checked").val());
            setDbItem("AudioSrcId", $("#microphoneSrc").val());
            setDbItem("AutoGainControl", ($("#Settings_AutoGainControl").is(':checked'))? "1" : "0");
            setDbItem("EchoCancellation", ($("#Settings_EchoCancellation").is(':checked'))? "1" : "0");
            setDbItem("NoiseSuppression", ($("#Settings_NoiseSuppression").is(':checked'))? "1" : "0");
            setDbItem("RingOutputId", $("#ringDevice").val());
            ...
            if(EnableAppearanceSettings){
                ...
                setDbItem("profileVcard", JSON.stringify(vCard));
                ...
                $("#ImageCanvas").croppie('result', options).then(function(base64) {
                    setDbItem("profilePicture", base64);
                    $("#Appearance_Html").hide();

                    // Notify Changes
                    //Alert(lang.alert_settings, lang.reload_required, function(){window.location.reload();});
            ...
            if(EnableNotificationSettings){
                setDbItem("Notifications", ($("#Settings_Notifications").is(":checked"))? "1" : "0");
            }
...
function ToggleAutoAnswer(){
    ...
    setDbItem("AutoAnswerEnabled", (AutoAnswerEnabled == true)? "1" : "0");
...
function ToggleDoNoDisturb(){
    ...
    if(DoNotDisturbEnabled == true){
        ...
        DoNotDisturbEnabled = false
        setDbItem("DoNotDisturbEnabled", "0");
        ...
        DoNotDisturbEnabled = true
        setDbItem("DoNotDisturbEnabled", "1");
        $("#dereglink").attr("class", "dotDoNotDisturb");
...
function ToggleCallWaiting(){
    ...
    setDbItem("CallWaitingEnabled", (CallWaitingEnabled == true)? "1" : "0");
...
function ToggleRecordAllCalls(){
    ...
    setDbItem("RecordAllCalls", (RecordAllCalls == true)? "1" : "0");
...
function XmppGetBuddyVcard(buddyObj){
    ...
    XMPP.sendIQ(iq_request, function (result){
        ...
        if(imgBase64 != ""){
            ...
            setDbItem("img-"+ buddyObj.identity + "-"+ buddyObj.type, imgBase64);
